...
const AdminPage: React.FC = () => {
  ...
  useEffect(() => {
    const loadData = async (): Promise<void> => {
      ...
      try {
        ...
        const questionsResponse = await fetch('http://localhost:5001/api/questions');
  ...
  const handleDuplicateQuiz = async (quiz: Quiz): Promise<void> => {
    try {
      ...
      const response = await fetch(`http://localhost:5001/api/quizzes/${quiz.id}/duplicate`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleUpdateQuestion = async (): Promise<void> => {
    if (
      ...
      try {
        ...
        const response = await fetch(`http://localhost:5001/api/questions/${editingQuestion.id}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const handleAddSelectedQuestions = async (): Promise<void> => {
    ...
    try {
      ...
      const updatePromises = selectedExistingQuestions.map(question => {
        ...
        return fetch(`http://localhost:5001/api/questions/${question.id}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const handleSaveQuiz = async (): Promise<void> => {
    try {
      if (quizForm.isNewQuiz) {
        ...
        const response = await fetch(`http://localhost:5001/api/quizzes/${editingQuiz.id}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
          },
