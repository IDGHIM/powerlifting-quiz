...
const quizDatabase = {
    culture: [
        ...
        { question: "Quel powerlifter détient le record du monde IPF en squat en RAW en +120 kg (2025) ?", answers: ["Ray Williams", "Blaine Sumner", "Jesus Olivares"], correctAnswer: "Jesus Olivares", difficulty: "hard", category: "culture" },
    ...
    reglement: [
        { question: "Quelle est la taille maximale autorisée pour la ceinture en compétition IPF ?", answers: ["13 mm d'épaisseur", "10 mm d'épaisseur", "15 mm d'épaisseur"], correctAnswer: "13 mm d'épaisseur", difficulty: "easy", category: "reglement" },
        ...
        { question: "Est‑ce que le lifter peut parler pendant l’élévation ?", answers: ["Oui, pour se motiver", "Non, c’est interdit", "Oui, seulement s’il demande le signal"], correctAnswer: "Oui, pour se motiver", difficulty: "easy", category: "reglement" },
        ...
        { question: "Que se passe‑t‑il si un lifter relâche la barre au sol après le deadlift sans signal?", answers: ["Essai validé", "Essai non validé", "Interdit et disqualification"], correctAnswer: "Essai non validé", "difficulty": "medium", category: "reglement" },
        { question: "Doit‑on attendre le signal 'Down' pour enregistrer la fin du deadlift ?", answers: ["Oui", "Non", "Parfois"], correctAnswer: "Oui", difficulty: "medium", category: "reglement" },
        ...
        { question: "Quel vêtement est obligatoire en IPF Classic ?", answers: ["T‑shirt manches longues", "T‑shirt IPF", "T‑shirt moulant réglementé"], correctAnswer: "T‑shirt IPF", difficulty: "easy", category: "reglement" },
        ...
        { question: "Quel signal indique au lifter qu’il peut ranger la barre au squat ?", answers: ["\"Rack\"", "\"Down\"", "\"Riser\""], correctAnswer: "\"Rack\"", difficulty: "medium", category: "reglement" },
        ...
        { question: "Les bandages de genou sont‑ils autorisés en full power ?", answers: ["Oui, selon épaisseur", "Non", "Oui, sans limite"], correctAnswer: "Non", difficulty: "easy", category: "reglement" }
    ...
    biomecanique: [
        ...
        { question: "Quel muscle est le plus activé dans le développé couché ?", answers: ["Pectoraux", "Quadriceps", "Grand dorsal"], correctAnswer: "Pectoraux", difficulty: "easy", category: "biomecanique" },
        { question: "Quel groupe musculaire stabilise l'épaule lors du développé couché  ?", answers: ["Coiffe des rotateurs", "Triceps", "Quadriceps"], correctAnswer: "Coiffe des rotateurs", difficulty: "medium", category: "biomecanique" },
        ...
        { question: "Quel mouvement articulaire se produit principalement dans le développé couché ?", answers: ["Extension du coude", "Flexion du genou", "Abduction de la hanche"], correctAnswer: "Extension du coude", difficulty: "easy", category: "biomecanique" },
        ...
        { question: "Quel muscle est le plus impliqué dans la flexion du coude lors du développé couché ?", answers: ["Biceps", "Triceps", "Grand dorsal"], correctAnswer: "Biceps", difficulty: "medium", category: "biomecanique" },
        ...
        { question: "Quelle est la fonction biomécanique du triceps dans le développé couché ?", answers: ["Extension du coude", "Stabilisation du genou", "Rotation de la hanche"], correctAnswer: "Extension du coude", difficulty: "easy", category: "biomecanique" },
        ...
        { question: "Quel muscle est essentiel pour verrouiller la barre au développé couché ?", answers: ["Triceps", "Quadriceps", "Ischio-jambiers"], correctAnswer: "Triceps", difficulty: "medium", category: "biomecanique" },
        ...
        { question: "Quel muscle permet de stabiliser la scapula au développé couché ?", answers: ["Trapèzes inférieurs", "Quadriceps", "Adducteurs"], correctAnswer: "Trapèzes inférieurs", difficulty: "medium", category: "biomecanique" },
        ...
        { question: "Quel muscle limite la rotation interne de l'épaule lors du développé couché ?", answers: ["Coiffe des rotateurs", "Quadriceps", "Grand fessier"], correctAnswer: "Coiffe des rotateurs", difficulty: "medium", category: "biomecanique" },
        ...
        { question: "Quel muscle contrôle la charge pendant la phase excentrique du développé couché ?", answers: ["Pectoraux", "Quadriceps", "Ischio-jambiers"], correctAnswer: "Pectoraux", difficulty: "medium", category: "biomecanique" },
        ...
        { question: "Quel muscle est prioritairement ciblé dans le développé couché prise serrée ?", answers: ["Triceps", "Pectoraux", "Deltoïdes postérieurs"], correctAnswer: "Triceps", difficulty: "medium", category: "biomecanique" },
        ...
        { question: "Quel muscle est responsable de l'extension du coude dans le développé couché ?", answers: ["Triceps", "Biceps", "Pectoraux"], correctAnswer: "Triceps", difficulty: "easy", category: "biomecanique" },
        ...
        { question: "Quel muscle stabilise les omoplates pendant le développé couché ?", answers: ["Trapèzes moyens", "Quadriceps", "Adducteurs"], correctAnswer: "Trapèzes moyens", difficulty: "medium", category: "biomecanique" },
